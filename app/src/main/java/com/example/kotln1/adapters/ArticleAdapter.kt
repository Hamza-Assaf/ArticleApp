package com.example.kotln1.adapters
    ...
    class ViewHolder(private val itemBinding: ArticleCardBinding) :
        ...
        fun bind(article: Article) {
            ...
            itemBinding.root.setOnClickListener{
                ...
                val toItem = ArticleListFragmentDirections.actionArticleListToArticleDetails(article.getTitle(),article.getDescription(), article.getUrlToImage(),article.getUrl())
